...
public class XlsAnalizer {
    ...
    public List<MktCobStHisAgrupacion> analizeXls(InputStream file, String fileName) {
        List<MktCobStHisAgrupacion> cargas = new ArrayList<MktCobStHisAgrupacion>();
...
//            }
    ...
    public List<MktCobStHisAgrupacion> analizeSheet(Iterator<Row> rowIterator, String sheetName) {
        int numRow = 0;
        String year = "";
        List<MktCobStHisAgrupacion> cargas = new ArrayList<MktCobStHisAgrupacion>();
        Cell cell = null;
        ...
        MktCobStHisAgrupacion agrupacion = null;
        while (rowIterator != null && rowIterator.hasNext()) {
            ...
            if (numRow > 0) {
                ...
                if (encabezados[0].equalsIgnoreCase(encabezadosArchivo[0])) {
                    agrupacion = new MktCobStHisAgrupacion();
